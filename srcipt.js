...
const fliterButtons=document.querySelector("#fliter-btns").children;
const items=document.querySelector(".portfolio-gallery").children;

  for(let i=0; i<fliterButtons.length; i++){
  	fliterButtons[i].addEventListener("click",function(){
  		for(let j=0; j<fliterButtons.length; j++){
  			fliterButtons[j].classList.remove("active")
